...
let starWarsCharacters = [
  ...
  { name: "Princess Leia", eye_color: "brown" },
  { name: "R5-D4", eye_color: "red" },
  { name: "Leia Organa", eye_color: "blue-gray" },
  { name: "Obi-Wan Kenobi", eye_color: "red" },
  { name: "Biggs Darklighter", eye_color: "yellow" },
  { name: "R2-D2", eye_color: "brown" },
  { name: "C-3PO", eye_color: "blue" },
  { name: "Owen Lars", eye_color: "red" },

];

for (var i = 0; i < starWarsCharacters.length; i++) {
  switch (starWarsCharacters[i].eye_color) {    //uso lo statement switch per determinare il colore degli occhi di ciascun personaggio e inserire l'oggetto nell'array relativo al colore degli occhi nell'oggetto eyeColor
    case "blue":
